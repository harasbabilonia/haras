...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { animal_id: @venda.animal_id, cliente_id: @venda.cliente_id, n_parcelas: @venda.n_parcelas, tipo_venda_id: @venda.tipo_venda_id, valor: @venda.valor } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { animal_id: @venda.animal_id, cliente_id: @venda.cliente_id, n_parcelas: @venda.n_parcelas, tipo_venda_id: @venda.tipo_venda_id, valor: @venda.valor } }
